...
## 📌 Overview
This project analyses an IMDB movie dataset to identify the **optimal time of year to release a film** in order to maximise box office revenue.  
The analysis is conducted from an **investor perspective**, using historical data to uncover seasonal trends in movie performance.

---

## 🎯 Objectives
- Analyse how movie revenue varies across different months  
...
- Action and Sci-Fi perform best in summer  
...
- Market competition during peak blockbuster seasons  
...
```bash
git clone https://github.com/yourusername/imdb-release-analysis.git
